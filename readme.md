Thank you for taking a look to my project. This is a simple node application that can be used on a server to send data from a contact me form straight to your email inbox using sendgrid.
